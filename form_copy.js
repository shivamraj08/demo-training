import { View, Text, StyleSheet, TextInput, TouchableOpacity, FlatList, Image,SafeAreaView,Modal} from 'react-native'
      ...
      <View style={styles.Container}>
        <View>
          <TextInput
            ...
            <Text style={{ color: 'red',height:15 }}>{nameValidError ? nameValidError : null}</Text>
          <TextInput
            value={email}
            style={styles.body}
            placeholder='Email'
